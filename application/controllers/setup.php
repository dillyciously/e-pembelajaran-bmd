                ...
                if (empty($this->db_error)) {
                    ...
                    $data_pengaturan = array(
                        ...
                        array(
                            ...
                            'value' => '{"subject":"Pengaktifan Akun","body":"<p>Hai {$nama},<\\/p>\\n<p>Anda telah diterima sebagai pengajar pada {$nama_sekolah}, berikut informasi data diri anda:<\\/p>\\n<p>{$tabel_profil}<\\/p>\\n<p>Anda dapat login ke sistem E-Pembelajaran menggunakan username dan password yang telah anda buat saat pendaftaran, login pada url berikut : {$url_login}<\\/p>"}'
                        ),
                        array(
                        ...
                        array(
                            ...
                            'value' => '{"subject":"Registrasi Berhasil","body":"<p>Hai {$nama},<\\/p>\\n<p>Terimakasih telah melakukan pendaftaran sebagai pengajar di E-Pembelajaran {$nama_sekolah}. Akun anda akan segera diaktifkan oleh admin.<\\/p>"}'
                        ),
                        array(
