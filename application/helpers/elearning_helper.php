...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        ...
        'copyright_setup'   => 'Copyright &copy; 2017 - ' . date('Y') . ' BPAD - <a href="http://bpad.jakarta.go.id">bpad.jakarta.go.id</a>',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Tahun Anggaran ' . date('Y') . ' ' . ' <a href="http://bpad.jakarta.go.id"> Badan Pengelolaan Aset Daerah Provinsi DKI Jakarta  </a>';
        $return['site_name'] = 'e-Pembelajaran BMD ';
