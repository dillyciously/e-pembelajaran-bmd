...
class config {
  ...
  public static $default = array(
    ...
    // login
    'username' => 'dilly',
    'password' => '$2y$10$Rf5KosDrKQnolteoQNoVr.Z0rkqTt3JwLBGUeZ7/dUZoNrEb7.s.G', // Add password directly or use https://tinyfilemanager.github.io/docs/pwd.html to encrypt the password (encrypted password is more secure, as it prevents your password from being exposed directly in a file).
