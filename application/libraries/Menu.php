...
class Menu
{
    ...
    private function default_menu()
    {
        $this->menus['admin'] = array(
            ...
            1 => array(
                '<a href="' . site_url('siswa'). '"><i class="menu-icon icon-group"></i>Peserta <span class="menu-count-pending-siswa"></span></a>',
        ...
        $this->menus['pengajar'] = array(
            ...
            2 => array(
                ...
                '<a href="' . site_url('siswa/filter') . '"><i class="menu-icon icon-search"></i>Filter Peserta </a>'
            ),
            3 => array(
                '<a href="' . site_url('login/logout') . '"><i class="menu-icon icon-signout"></i>Logout </a>'
            )
